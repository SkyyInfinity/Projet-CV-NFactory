...
<section class="site-main">
    <div class="wrap">
        ...
        <!-- <div class="image-a-propos">
            <img src="<?php echo get_template_directory_uri() ?> /asset/img/logo-cv.png" alt="">
        </div> -->


        <div class="container-title-text-propos">
            <div class="image-a-propos">
                <img src="<?php echo get_template_directory_uri() ?> /asset/img/cv-logo2.png" alt="">
            </div>
